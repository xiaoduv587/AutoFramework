    ...
    <xsl:template name="testMethods">
        ...
        <div style="width: 200px;">
            <label for="groupMethodsCheckBox" style="font-weight: bold; margin: 0;">
                <input id="groupMethodsCheckBox" checked="checked" type="checkbox"
        ...
        <div id="testMethodsByStatus" style="display:none">
            <!-- <xsl:if runShellRetry="testng:isFilterSelected('BY_CLASS') = 'true'">
        ...
        <div id="testMethodsByClass" style="display:block">
            <!--  <xsl:if runShellRetry="testng:isFilterSelected('BY_CLASS') != 'true'">
                <xsl:attribute name="style" select="'display: none;'" />
            </xsl:if>-->
            <xsl:for-each select="$classes">
                ...
                <table class="testMethodsTable" cellpadding="0" cellspacing="0">
                    ...
                    <xsl:call-template name="testMethodsList">
                        <!--<xsl:with-param name="methodList" select="./runShellRetry-method[not(@is-config)]"/> -->
